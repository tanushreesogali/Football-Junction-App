...
const Table = ({ group, data }) => {
  return (
    <div className={styles["pt-table-container"]}>
      <p className={styles['pt-group']}>{group}</p>
      <table className={styles["pt-table"]}>
        ...
        <tbody>
          {data.map((row, index) => (
            <tr key={index}>
              <td>{row.pos}</td>
              <td className={styles['pt-team-name']}>{row.team}</td>
              <td>{row.played}</td>
              <td>{row.won}</td>
              <td>{row.draw}</td>
              <td>{row.lost}</td>
...
const TableT = () => {
  return (
    <div className={styles['pt-content']}>
      <Table group="GROUP A" data={data.groupA} className={styles['points-table']} />
      <br/>
      <Table group="GROUP B" data={data.groupB} className={styles['points-table']}/>
    </div>
  );
};
